...
<li x-data="{ tooltip: false }" class="relative">
    <a href="{{ route('verify-request.admin') }}" wire:navigate x-on:mouseenter="tooltip = !tooltip"
        x-on:mouseleave="tooltip = false" :class="expanded ? 'w-fit' : 'w-full'"
        class="inline-flex items-center gap-3 text-sm font-medium hover:text-[#6D9773] py-2 px-2 rounded-md">
...
{{-- User Management --}}
<li x-data="{ tooltip: false }" class="relative">
    <a href="{{ route('user-manage.admin') }}" wire:navigate x-on:mouseenter="tooltip = !tooltip"
        x-on:mouseleave="tooltip = false" :class="expanded ? 'w-fit' : 'w-full'"
        class="inline-flex items-center gap-3 text-sm font-medium hover:text-[#6D9773] py-2 px-2 rounded-md">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
...
{{-- Content Moderation --}}
<li x-data="{ tooltip: false }" class="relative">
    <a href="{{ route('content-moderate.admin') }}" wire:navigate x-on:mouseenter="tooltip = !tooltip"
        x-on:mouseleave="tooltip = false" :class="expanded ? 'w-fit' : 'w-full'"
        class="inline-flex items-center gap-3 text-sm font-medium hover:text-[#6D9773] py-2 px-2 rounded-md">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
...
{{-- Profile --}}
<li x-data="{ tooltip: false }" class="relative">
    <a href="{{ route('profile.admin') }}" wire:navigate x-on:mouseenter="tooltip = !tooltip"
        x-on:mouseleave="tooltip = false" :class="expanded ? 'w-fit' : 'w-full'"
        class="inline-flex items-center gap-3 text-sm font-medium hover:text-[#6D9773] py-2 px-2 rounded-md">
        {{-- profile picture --}}
        <svg xmlns="http://www.w3.org/2000/svg" class="text-[#D9D9D9]" width="24" height="24" viewBox="0 0 20 20" fill="currentColor">
