<div class="md:w-3/4 md:mx-auto">
    ...
    @endif
    <h1 class="text-[#0C3B2E] text-center text-2xl md:text-3xl font-extrabold mb-10">Select your Fields</h1>
    ...
    <div class="h-[200px] md:h-[300px] overflow-y-scroll soft-scrollbar">
