<div>
    <div class="flex sm:flex-col gap-8 justify-center">
        {{-- STEP 1 --}}
        <div class="flex flex-col gap-4">
            <p class="font-semibold text-xl text-[#1589C3] text-nowrap">Step 1</p>
            <div class="flex h-11 items-center gap-2">
                <div class="h-full w-1 rounded-md bg-[#1589C3]"></div>
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex h-11 items-center gap-2">
                ...
                <div class="sm:block hidden">
                    ...
                    <p class="lg:block hidden text-[#64748B]">Get your Tutee account</p>
                </div>
            </div>
        </div>
