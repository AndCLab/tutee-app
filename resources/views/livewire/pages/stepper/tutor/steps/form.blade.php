            ...
            @foreach ($inputs as $index => $input)
                <div class="md:flex md:items-start md:gap-3 space-y-3 md:space-y-0">
                    ...
                    <div>
                        ...
                        <x-danger-button wire:click='remove_work({{ $index }})' class="md:hidden block w-full">Remove
                            Work Experience</x-danger-button>
                    </div>
                </div>
            @endforeach
            {{-- Add Work --}}
            <x-white-button class="w-full" wire:click='add_work' emerald label="Add Work Experience">
