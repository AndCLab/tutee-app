<div class="w-2/3 mx-auto">
    <div class="mb-5">
        <input type="radio" id="tutee" name="tutee" value="tutee" class="hidden peer/tutee" wire:model="user_type"/>
        <label for="tutee"
    ...
    <div class="mb-5">
        <input type="radio" id="tutor" name="tutor" value="tutor" class="hidden peer/tutor" wire:model="user_type"/>
        <label for="tutor"
