    ...
    <div class="grid grid-cols-2 gap-5">
        <div>
            ...
            <label for="tutee"
                ...
                <div class="mx-auto">
                    <img class="size-52 mix-blend-multiply object-contain" src="{{ asset('images/tutee-role.jpg') }}"
                        alt="">
        ...
        <div>
            ...
            <label for="tutor"
                ...
                <div class="mx-auto">
                    <img class="size-52 mix-blend-multiply object-contain" src="{{ asset('images/tutor-role.jpg') }}"
                        alt="">
