...
@if ($showReportClassModal)
    <x-wui-modal.card title="Report Content: Keep Our Community Safe and Respectful"
        wire:model="showReportClassModal" class="space-y-3" align='center' max-width='xl'>
        ...
        <x-slot name='footer'>
            <x-wui-button wire:click="submitClassReport" spinner="submitClassReport" class="w-full" label="Report" negative icon="exclamation"/>
        </x-slot>
    </x-wui-modal.card>
@endif
